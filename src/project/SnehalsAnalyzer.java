...
public class SnehalsAnalyzer extends StopwordAnalyzerBase {
	...
	public static final CharArraySet ENGLISH_STOP_WORDS_SET;
	  ...
	  static {
	    final List<String> stopWords = Arrays.asList(
	    		  "a", "an", "and", "are", "as", "at", "be", "but", "by",
	    	        ...
	    	        "they", "this", "to", "was", "will", "with"	, "ll","'tis","'twas","'ve","10","39","a","a's","able","ableabout","about",
	   ...
	   */
	  public SnehalsAnalyzer(CharArraySet stopwords) {
	   ...
	   */
	  public SnehalsAnalyzer(CharArraySet stopwords, CharArraySet exclusionSet) {
	    super(stopwords);
